...
## ObfuscatePass (method level pass?)
...
## ReduceGotosPass (cfg manipulation?)
...
## RemoveBuildersPass (inter and introprocedural reachability analysis?)
...
## RemoveEmptyClassesPass (class level pass, very coarse)
...
## RenameClassesPassV2 (class level pass)
...
## ReorderInterfacesDeclPass (analysis pass)
...
## MethodInlinePass (interprocedural analysis)
...
## StringConcatenatorPass (find a clinit method and only performed on static initializers
...
## StripDebugInfoPass (has pass dependency?)
